    ...
    <div className="relative">
      ...
      >
        ...
        <button
          ...
          className="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-left font-medium text-gray-700 group text-theme-sm hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
        >
