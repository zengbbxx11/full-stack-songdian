...
export default function CookieSettingsTrigger() {
  return (
    <button
      ...
      className={cn(
        "rounded-md text-[14px] text-[#777b81] transition-colors duration-[330ms] hover:text-[var(--foreground)] focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-ring/50"
      )}
    >
      Cookie Settings
    </button>
